...
private_channel_raw = os.getenv("PRIVATE_CHANNEL_ID", "-1003543534808")
try:
    PRIVATE_CHANNEL_ID = int(private_channel_raw)
except ValueError:
    raise ValueError("❌ PRIVATE_CHANNEL_ID должен быть числом!")

# Реквизиты для оплаты картой
PAYMENT_CARD_ALIF = os.getenv("PAYMENT_CARD_ALIF", "+992888788181")
PAYMENT_CARD_MASTERCARD = os.getenv("PAYMENT_CARD_MASTERCARD", "5413525250170749")

# YooMoney настройки для платежей
YOOMONEY_TOKEN = os.getenv("YOOMONEY_TOKEN")
YOOMONEY_WALLET = os.getenv("YOOMONEY_WALLET")
YOOMONEY_ENABLED = bool(YOOMONEY_TOKEN and YOOMONEY_WALLET)
